            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="border-2 border-gray-300 bg-white focus:bg-white focus:border-gray-600 focus:ring-0 transition-all duration-200 text-gray-900 placeholder:text-gray-400 pr-12 rounded-lg h-12"
                />
                <Button
                  type="button"
                  variant="ghost"
