                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      required
                      className="border border-gray-200 bg-gray-50/50 focus:bg-white focus:border-gray-400 focus:ring-0 transition-all duration-200 text-gray-900 placeholder:text-gray-400 pr-12 rounded-lg h-12"
                    />
                    <Button
                      type="button"
                      variant="ghost"
                      size="sm"
                      className="absolute right-0 top-0 h-full px-3 py-2 hover:bg-gray-100/50 text-gray-500 hover:text-gray-700 transition-colors rounded-r-lg"
